...
// Fetch the latest sensor reading (example: one sensor)
$sensor_id = 1; // you can loop all sensors if needed
...
// If no reading exists yet, set default values
if(!$latest_reading){
    $sun_heat = 25;
    $is_raining = 0;
    $vent_state = 'off';
...
// Handle POST (manual or automatic)
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $humidity = 50; // simulate or fetch real value
